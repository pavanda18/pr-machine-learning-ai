...
st.markdown('<span style="font-size: 20px;margin-top: -24px;position: absolute;">Sample Data from 1st Jan 2021 to 31st Dec 2021 </span><br>', unsafe_allow_html=True,)

# Process company filters
company_filter_options = get_company_filter_options()   
selected_company = st.selectbox("Select Company", company_filter_options)    
